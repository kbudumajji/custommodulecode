 ...
 *
 */
package com.mss.cockpits.setup;
...
import com.mss.cockpits.constants.IntegrationwithjenCockpitsConstants;
 ...
 */
@SystemSetup(extension = IntegrationwithjenCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(IntegrationwithjenCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(IntegrationwithjenCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						IntegrationwithjenCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/integrationwithjencockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
