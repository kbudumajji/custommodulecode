 ...
 *
 */
package com.mss.cockpits.productcockpit.editor;
			...
			if (section instanceof CustomEditorSection)
			{
				...
				if (customSection.getSectionConfiguration() instanceof ExternalTaxesSectionConfiguration)
				{
					...
					if (secConfig != null)
					{
						...
						final Label rowLabel = new Label(Labels.getLabel("integrationwithjencockpits.product.externalTaxes"));
						rowLabel.setTooltiptext(Labels.getLabel("integrationwithjencockpits.product.externalTaxes"));
