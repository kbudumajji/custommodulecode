...
import com.mss.test.constants.IntegrationwithjenTestConstants;
import com.mss.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = IntegrationwithjenTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/integrationwithjentest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/integrationwithjentest/import/reviews.impex");
			...
			importImpexFile(context, "/integrationwithjentest/import/cstickets.impex");
		}
	}
}
