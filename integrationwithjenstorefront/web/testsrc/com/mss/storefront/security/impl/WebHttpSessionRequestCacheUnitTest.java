...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/integrationwithjenstorefront/electronics/en",
						"https://electronics.local:9002/integrationwithjenstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/integrationwithjenstorefront/electronics/en",
						"https://electronics.local:9002/integrationwithjenstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/integrationwithjenstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/integrationwithjenstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/integrationwithjenstorefront/electronics/en",
						"https://electronics.local:9002/integrationwithjenstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/integrationwithjenstorefront",
						"https://electronics.local:9002/integrationwithjenstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/integrationwithjenstorefront",
						"https://electronics.local:9002/integrationwithjenstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/integrationwithjenstorefront/electronics/en",
						"https://electronics.local:9002/integrationwithjenstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
