...
import com.mss.fulfilmentprocess.test.actions.TestActionTemp;
...
public class PaymentIntegrationTest extends ServicelayerTest
{
	...
	public static void prepare() throws Exception //NOPMD
	{
		...
		xmlReader.loadBeanDefinitions(new ClassPathResource(
				"/integrationwithjenfulfilmentprocess/test/integrationwithjenfulfilmentprocess-spring-test.xml"));
		xmlReader.loadBeanDefinitions(new ClassPathResource(
				"/integrationwithjenfulfilmentprocess/test/integrationwithjenfulfilmentprocess-spring-test-fraudcheck.xml"));
		xmlReader
				.loadBeanDefinitions(new ClassPathResource("/integrationwithjenfulfilmentprocess/test/process/order-process-spring.xml"));
		...
		definitonFactory.add("classpath:/integrationwithjenfulfilmentprocess/test/process/payment-process.xml");
	...
	public void setUpProductCatalogue()
	{
		try
		{
			...
			importCsv("/integrationwithjenfulfilmentprocess/test/testBasics.csv", "windows-1252");
			importCsv("/integrationwithjenfulfilmentprocess/test/testCatalog.csv", "windows-1252");
	...
	public static void removeProcessDefinitions()
	{
		...
		final XmlBeanDefinitionReader xmlReader = new XmlBeanDefinitionReader((BeanDefinitionRegistry) beanFactory);
		xmlReader.loadBeanDefinitions(new ClassPathResource(
				"/integrationwithjenfulfilmentprocess/test/integrationwithjenfulfilmentprocess-spring-testcleanup.xml"));
