 ...
 *
 */
package com.mss.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(IntegrationwithjenFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(IntegrationwithjenFulfilmentProcessConstants.PARENT_PROCESS);
